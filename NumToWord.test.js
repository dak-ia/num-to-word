...
describe("NumToWord", () => {
  describe("toEn - English Conversion", () => {
    ...
    test("handles numbers with commas", () => {
      ...
      expect(NumToWord.toEn("1，234，567")).toBe(
    ...
    test("handles ascending digits", () => {
      expect(NumToWord.toEn("123456789")).toBe(
        "One hundred twenty-three million four hundred fifty-six thousand seven hundred eighty-nine"
      );
    });

    test("handles descending digits", () => {
      expect(NumToWord.toEn("987654321")).toBe(
